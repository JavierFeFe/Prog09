...
public class CalculaNIF {
     ...
     */
    public static String isValido(String nif) throws ExcepcionNIF {
        if (nif.length() > 8) {
            nif = nif.replaceAll("-", "");
        ...
        throw new ExcepcionNIF("¡Formato de NIF no válido!");
    }
    ...
    public static class ExcepcionNIF extends Exception {
        public ExcepcionNIF(String msg) {
            super(msg);
        }
    }
}
